	...
	public function ai1ec_settings_observer( $old_options, $new_options ) {
		...
		if ( $this->is_current_theme_outside_core() ) {
			$this->_registry->get( 'notification.admin' )->store(
				Ai1ec_I18n::_trans( 'You have turned on Frontend Rendering and you are using a custom calendar theme. If your theme does not support Frontend Rendering, your calendar may not work correctly.' ),
				'error',
				0,
